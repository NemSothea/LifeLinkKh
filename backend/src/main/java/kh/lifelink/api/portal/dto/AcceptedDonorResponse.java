 ...
 * latitude}/{@code longitude} and no unrounded distance (ADR 0003); {@code districtName} is a plain
 * string here, matching {@code contract.md}'s documented shape, unlike the km/en pair used
