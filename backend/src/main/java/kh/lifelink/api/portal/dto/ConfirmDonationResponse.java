 ...
 * @param donorNextEligibleOn {@code donatedOn + 56 days}, returned so staff can tell the donor
 *     when to come back, which is the information the donor actually wants at that moment.
 */
