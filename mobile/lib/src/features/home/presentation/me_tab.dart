            ...
            body: SafeArea(
                child: ListView(
                    children: [
                        ...
                        // A donor whose relative needs blood is the most likely requester in
                        // the pilot (RequestController) — the donor shell's Home tab has no
                        // "request blood" button, so it lives here instead of being lost.
                        if (role == UserRole.donor)
                            ListTile(
